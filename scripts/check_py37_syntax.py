"""Verify pure-Python modules are syntax-compatible with Python 3.7 (3ds Max 2022).
...
This is enforced in CI via ``py37-syntax-check`` job. 3ds Max 2022 embeds
Python 3.7; pure-Python modules must remain importable on that host.
"""

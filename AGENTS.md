...
**Current version:** 0.2.13 <!-- x-release-please-version -->
...
## Bundled Skills (16 families, ~135 tools)
...
| `3dsmax-modeling` | authoring | `create_box`, `create_sphere`, `create_cylinder`, `create_plane`, `lathe_profile`, `draw_spline`, `inspect_curve`, `edit_curve`, `curve_model`, `loft_mesh` |
| `3dsmax-geometry-io` | authoring | `validate_geometry_file`, `import_fbx`, `import_geometry`, `export_fbx`, `export_obj` |
| `3dsmax-mesh-ops` | authoring | `get_mesh_topology`, `get_selected_mesh_topology`, `get_smoothing_groups`, `get_modifier_stack`, `add_modifier`, `remove_modifier`, `set_modifier_state`, `set_modifier_property`, `collapse_modifier_stack`, `make_modifier_unique`, `triangulate_meshes`, `cleanup_meshes`, `attach_meshes`, `detach_selected_faces`, `apply_subdivision`, `create_proxy_meshes`, `set_explicit_normals`, `clear_explicit_normals`, `assign_smoothing_group`, `boolean_operation` |
...
| `3dsmax-animation` | authoring | `set_keyframe`, `play_animation`, `get_time_settings`, `get_animation_controllers`, `list_keyframes`, `set_current_time`, `set_timeline_settings`, `set_transform_keyframe`, `delete_keyframes`, `set_key_interpolation`, `bake_transform_animation`, `export_animation_curves`, `import_animation_curves`, `set_keyframes`, `get_anim_curves`, `export_anim_curves`, `import_anim_curves` |

...
| `3dsmax-mesh-ops` | authoring | `get_mesh_topology`, `get_selected_mesh_topology`, `get_smoothing_groups`, `get_modifier_stack`, `add_modifier`, `remove_modifier`, `set_modifier_state`, `set_modifier_property`, `collapse_modifier_stack`, `make_modifier_unique`, `triangulate_meshes`, `cleanup_meshes`, `attach_meshes`, `detach_selected_faces`, `apply_subdivision`, `create_proxy_meshes`, `set_explicit_normals`, `clear_explicit_normals`, `assign_smoothing_group` |

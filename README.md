...
`dcc-mcp-core` 0.17.56 UI dispatcher, pump abstractions, and expanded readiness
probe (gateway guardian, sidecar readiness, main-thread executor). The legacy
...
- Python >= 3.7
- dcc-mcp-core >= 0.17.56
- dcc-mcp-server >= 0.17.56
